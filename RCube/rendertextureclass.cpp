...
void RenderTextureClass::TurnZBufferOn(ID3D11DeviceContext* deviceContext, ID3D11DepthStencilView* depthStencilView){

	deviceContext->OMSetRenderTargets(1, &m_renderTargetView, depthStencilView);

}

void RenderTextureClass::TurnZBufferOff(ID3D11DeviceContext* deviceContext){
