...
void FireParticleSystem::Shutdown()
{
	// Release the buffers.
	ShutdownBuffers();
...
void FireParticleSystem::Frame( FPSTimers& Timers )
{
//	srand( Timers.Seed );
...
void FireParticleSystem::ShutdownParticleSystem()
{
...
void FireParticleSystem::ShutdownBuffers()
{
	// +++++++++++++++++   Instancing   ++++++++++++++++++++++++++++++++
...
void FireParticleSystem::EmitParticles( FPSTimers& Timers )
{
...
void FireParticleSystem::UpdateParticles( FPSTimers& Timers )
{
	int i;
	float j = 0;
...
void FireParticleSystem::SetInstanceStartFrame( int FrameNumber, XMFLOAT4& Data2 )
{
...
void FireParticleSystem::DistanceCalk( XMFLOAT3 &ObjPos, XMFLOAT3 &Camerapos, float &DistanceStore )
{
...
void FireParticleSystem::ChangeActiveParticleAmount(int Amount)
{
	maxActiveParticles = Amount;
}


template <class T> void FireParticleSystem::QuickDepthSortAscending( T* indices, float* depths, int lo, int hi )
{
...
template <class T> void FireParticleSystem::QuickDepthSortDescending( T* indices, float* depths, int lo, int hi )
{
	//http://kvodo.ru/quicksort.html
	//  lo is the lower index, hi is the upper index
	//  of the region of array a that is to be sorted
