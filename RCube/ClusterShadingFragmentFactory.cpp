...
{
	uint64_t x_segment = masks[0 + (uint64_t)x1 * 4 + (uint64_t)x2];
	uint64_t y_segment = masks[16 + (uint64_t)y1 * 4 + (uint64_t)y2];
	uint64_t z_segment = masks[32 + (uint64_t)z1 * 4 + (uint64_t)z2];
